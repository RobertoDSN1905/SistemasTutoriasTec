<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Materias.aspx.cs" Inherits="AsesoriasTEC2019.Materias" %>
			...
			<header class="header">
				<div class="logo-container">
					<a href="../4.0.0" class="logo">
						<img src="TecNMX.png" width="75" height="35" alt="Porto Admin" />
					</a>
				            ...
				            <nav id="menu" class="nav-main" role="navigation">
				                ...
				                <ul class="nav nav-main">
									...
									<li runat="server" id="menu1" visible="false">
                                        <a class="nav-link" href="RegistrarMaterias.aspx">
                                            <i class="bx bx-home-alt" aria-hidden="true"></i>
				...
				<section role="main" class="content-body">
					...
					<div class="row">
						<div class="col-lg-4 col-xl-3 mb-4 mb-xl-0">
                            ...
                            <div class="col-lg-10 col-xl-8 mb-10 mb-xl-0">
                                            ...
                                            <div class="card-body bg-light">
                                                <div class="image-frame mb-2">
                                                    <div class="image-frame-wrapper">
                                                        <a href="ecommerce-products-form.html"><img src="img/products/product-1.jpg" class="img-fluid" alt="Materia" /></a>
                                                    </div>
                                                </div>
                                                <small><a href="ecommerce-products-form.html" class="ecommerce-sidebar-link text-color-grey text-color-hover-primary text-decoration-none">ASESOR</a></small>
                                                <p><%# Eval("descripcion").ToString() %></p>
												
                                                <div runat="server" id="Ocultar" class="product-price">
													<asp:Label runat="server" ID="ocultarLabel" Visible="false">prueba</asp:Label>
                                                      </div>
												
                                                    <asp:LinkButton runat="server" ID="btnRegistro" OnClick="btnRegistro_Click" type="submit" class="btn btn-primary mt-2" >Registrarse</asp:LinkButton>
